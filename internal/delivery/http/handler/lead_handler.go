...
func (h *LeadHandler) Submit(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprintf(w, `
		<div class="p-6 bg-emerald-50 border border-emerald-200 rounded-2xl text-center space-y-3 animate-fade-in">
			...
			<h4 class="text-base font-bold text-navy-900 font-serif">Inquiry Confirmed, %s!</h4>
			<p class="text-xs text-slate-600 leading-relaxed max-w-sm mx-auto">
				Our senior property advisor has received your details and will connect with verified documentation within 2 business hours.
			</p>
			<div class="pt-2">
	...
	`, result.Lead.Name, result.WhatsAppURL)
}
